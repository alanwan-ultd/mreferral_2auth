...
var l=Array.from(a.querySelectorAll("script")).map((function(t){
	if(t.attributes.getNamedItem("src")){
...
})),window.scrollTo(0,0),n.innerHTML="",n.appendChild(a),(c=document.querySelectorAll(".view-script")).length&&c.forEach((function(t){t.remove()})),
...
}(l),window.location.hash=t}else window.location.href=i.errorPage;var c},o.send()},
n._setUpUrl=function(t){
	t=t.replace(/^\//,"").split("_?_")[0],
	window.t1=t.split("_list")[0],
	window.t1=window.t1.split("_edit")[0],
	Array.from(document.querySelectorAll(Q)).forEach((function(t){t.classList.remove("c-active")})),
	Array.from(document.querySelectorAll(Q)).forEach((function(t){t.classList.remove("c-active")})),
	Array.from(document.querySelectorAll(".c-sidebar-nav-dropdown")).forEach((function(t){t.classList.remove("c-show")})),
