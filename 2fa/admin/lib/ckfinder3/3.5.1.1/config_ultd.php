...
switch ($section) {
	case "cashRebateForm": $resourceType = 'cashRebateForm'; break;
	case "adminuserSignature": $resourceType = 'adminuserSignature'; break;
	case "adminuserProfilePic": $resourceType = 'adminuserProfilePic'; break;
