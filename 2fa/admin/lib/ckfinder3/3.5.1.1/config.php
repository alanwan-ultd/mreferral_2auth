...
$config['authentication'] = function () {
    if(isset($_SESSION['sales_groupId']) && $_SESSION['sales_groupId'] > 0){
		return true;
	}else{
		return false;
	}
...
$config['backends'][] = array(
	'name'         => 'default',
	'adapter'      => 'local',
	/*'baseUrl'      => '/ckfinder/userfiles/',*/'baseUrl'      => $setting->CMS_CKFINDER_OUTPUTLINK,
...
$config['resourceTypes'][] = array(
	'name'              => 'cashRebateForm',
	'directory'         => 'images/cashRebateForm',
	'maxSize'           => 0,
	'allowedExtensions' => 'bmp,gif,jpeg,jpg,png',
	'deniedExtensions'  => '',
	'backend'           => 'default'
...
$config['resourceTypes'][] = array(
	'name'              => 'adminuserSignature',
	'directory'         => 'images/adminuser/signature',
	'maxSize'           => 0,
	'allowedExtensions' => 'bmp,gif,jpeg,jpg,png',
	'deniedExtensions'  => '',
	'backend'           => 'default'
...
$config['resourceTypes'][] = array(
	'name'              => 'adminuserProfilePic',
	'directory'         => 'images/adminuser/profile_pic',
	'maxSize'           => 0,
	'allowedExtensions' => 'bmp,gif,jpeg,jpg,png',
	'deniedExtensions'  => '',
	'backend'           => 'default'
