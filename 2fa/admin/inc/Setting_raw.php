...
class Setting{
	...
	//db
	public $DB_URL = "db";  //db, localhost
	public $DB_PORT = "3306";  //3306
	public $DB_USERNAME = "root";  //root
	public $DB_PASSWORD = "example";  //example, 123456
	public $DB_TABLE = "mreferral";  //mreferral, cms
	...
	public $CMS_LIVE_LINK = '/cash-rebate/';
	...
	public $MAIL_SMTP_USERNAME = "ultdmailserver@gmail.com";
	public $MAIL_SMTP_PWD = "moiukgcgmkityrce";
	public $MAIL_CONTACT_FROM = [
        'email'=>'test@test.com',
        'name'=>'test'
    ];
    public $MAIL_CONTACT_TO = [
        'email'=>'alan.wan@ultd.com.hk',
        'name'=>'alan test'
    ];
